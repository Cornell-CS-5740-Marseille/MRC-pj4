...
my_prep = Preprocessing(False)
my_prep.load_file('data/development.json', False) # True: testing; False: training
fhandle1 = open("data/POS_tag_validation_final2.txt",'w')
fhandle2 = open("data/NER_tag_validation_final2.txt",'w')
count = 0
