...
if __name__ == "__main__":
    ...
    try:
        ...
        path_to_predictions = os.path.join(os.getcwd(), "../output/output_baseline3.json")
...
if __name__ == "__main__":
    ...
    try:
        ...
        path_to_data = os.path.join(os.getcwd(), "data/development.json")

    try:
        path_to_predictions = sys.argv[2]
    except:
        path_to_predictions = os.path.join(os.getcwd(), "output/output_baseline4.json")
    ...
    print("recall score: " + str(r))
    print("f_1 measure: " + str(f))
>>>>>>> f0b0a75bf381634659e9438fc20aec32552d74a7:evaluate.py
